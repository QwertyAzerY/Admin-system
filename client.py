    ...
    async def execute_command(self, command_str:bytes):
        ...
        match command_name:
            case b'usrs':
                ...
                if result!=None and result!='':
                    ...
                    if r[0]:
                        ...
                        bytes_to_send=bytearray(b'2')+bytearray(command_id)+bytearray(b'usrs')+bytearray('ERROR scraping result', encoding="utf-8")
                else:
            ...
            case b'exec':
                ...
                clogger.debug(f'Started exec {command_id}')
